...
**Repository:** [djvreeman/usg-reg-comments](https://github.com/djvreeman/usg-reg-comments)  
**Upstream:** fork of [jmandel/regulations.gov-comment-browser](https://github.com/jmandel/regulations.gov-comment-browser)  
**License:** MIT (see [LICENSE](LICENSE) and [NOTICE](NOTICE))

This fork adds Gemini-oriented pipeline paths, multi-docket static site tooling, and HL7-oriented dashboard styling (Gotham preferred in the font stack when licensed fonts are supplied locally; system UI / sans-serif fallbacks otherwise). Analysis databases and published site output are kept out of git.
