...
function generateHTML(regulations: RegulationInfo[]): string {
  ...
  const siteBase = "https://usg-reg-comments.danielvreeman.com";
  const skillUrl = `${siteBase}/skill/SKILL.md`;
  const skillPrompt = `Please read ${skillUrl} and then help me analyze public comments on federal regulations.`;
...
<head>
  ...
  <title>Interoperability Comment Summaries for Regulations.gov</title>
  ...
  <style>
    ...
    * {
    ...
    .regulation-card:hover {
      box-shadow: 0 4px 12px rgba(0, 17, 64, 0.12);
      transform: translateY(-2px);
      outline: 1px solid var(--hl7-light-blue);
    }
    ...
    .skill-section {
      ...
      padding: 2rem;
      border-radius: 0.5rem;
      box-shadow: 0 4px 6px rgba(0, 17, 64, 0.12);
      margin-bottom: 1.5rem;
      color: white;
      border-top: 4px solid var(--hl7-red);
    }
...
<body>
  <header>
    ...
    <div class="container">
      <h1>Interoperability Comment Summaries for Regulations.gov</h1>
  ...
  <main class="container">
    ...
    <div class="skill-section">
      ...
      <div class="prompt-box" onclick="copyPrompt(this)">
        ...
        Please read ${skillUrl} and then help me analyze public comments on federal regulations. <code>[Ask your question here]</code>
      </div>
      <div class="skill-links">
        <a href="https://claude.ai/new?q=${encodeURIComponent(skillPrompt)}" class="skill-link" target="_blank">
          Open in Claude &rarr;
        </a>
        <!-- ChatGPT sandbox prevents web access, so this doesn't work -->
        <!-- <a href="https://chatgpt.com/?q=${encodeURIComponent(skillPrompt)}" class="skill-link" target="_blank">
    ...
    <div class="about-section">
      ...
      <ul>
        <li>Written docket overviews synthesizing what commenters asked HHS or FDA to do</li>
