...
import { getGenerationFunction, generateWithGemini3FlashWithMetadata, type UsageMetadata } from "../lib/llm-providers";
        ...
        for (let gi = 0; gi < themeGroups.length; gi++) {
          ...
          if (cached) {
            ...
            if (effectiveModel === "claude") {
              const generateFn = getGenerationFunction("claude");
