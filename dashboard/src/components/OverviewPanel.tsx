...
function OverviewPanel() {
  ...
  return (
    <div className="space-y-6">
      <a
        href="./analysis.html"
        className="block rounded-lg border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-900 hover:bg-blue-100"
      >
        <span className="font-semibold">Written overview</span>
        <span className="mx-2 text-blue-400">·</span>
        Docket-level synthesis of what commenters asked, where they agree, and the live fights.
        <span className="ml-2 font-medium">Read the memo →</span>
      </a>
